  ...
  <nav class="navbar fixed-top navbar-light bg-light">
    <table width="100%">
      <tr>
        ...
        <td>
          <div align="right">
          <a href="versiontales.php" data-toggle="tooltip" title="Refresh" class="btn btn-danger" role="button"><font color="#ffffff"><span uk-icon="refresh"></span></font></a>
        </div>
        </td>
      </tr>
      <tr>
