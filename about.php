        ...
        <nav class="navbar fixed-top navbar-light bg-light">
          <table width="100%">
            <tr>
              ...
              <td>
                <div align="right">
                <a href="about.php" data-toggle="tooltip" title="Refresh" class="btn btn-danger" role="button"><font color="#ffffff"><span uk-icon="refresh"></span></font></a>
              </div>
              </td>
            </tr>
            <tr>
...
<div class="uk-card uk-card-secondary uk-card-body " style="margin-top:10px; width:97%">
    <h3 class="uk-card-title"><span class="uk-margin-small-right" uk-icon="info"></span> About Us</h3>
</div>
</center>
