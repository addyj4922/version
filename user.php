...
<head>
  <title>Welcome to VERSION</title>
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
      ...
      <body id="bodyb" style="font-family: 'Raleway', sans-serif;" onload="browserDetect()">
      <nav class="navbar fixed-top navbar-light bg-light">
        <table width="100%">
          <tr>
            ...
            <td>
              <div align="right">
              <a href="user.php" data-toggle="tooltip" title="Refresh" class="btn btn-danger" role="button"><font color="#ffffff"><span uk-icon="refresh"></span></font></a>
            </div>
            </td>
          </tr>
          <tr>
...
<div style="margin-top:80px">
  <h1>Hello folks! Welcome to version</h1>
</div>
